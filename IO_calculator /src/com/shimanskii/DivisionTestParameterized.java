...
import static com.shimanskii.Operations.Division;
...
public class DivisionTestParameterized {
    ...
    public void division() {
        ...
        System.out.println("I wonder if I see this every test");
        assertEquals("something wrong with division", expected, Division(Operand1, Operand2, operation), 0.01);
